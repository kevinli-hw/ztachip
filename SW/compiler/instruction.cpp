...
bool cInstruction::fm_post(cInstruction *begin)
{
   ...
   for (instruction = begin; instruction; instruction = (instruction == end) ? 0 : (cInstruction *)instruction->getNext())
   {
      ...
      else if (instruction->m_alu1.oc == cConfig::OPCODE_SHLA || instruction->m_alu1.oc == cConfig::OPCODE_SHRA || instruction->m_alu1.oc == cConfig::OPCODE_QUANT_MUL)
      {
         // Nothing to do...
      }
      else
