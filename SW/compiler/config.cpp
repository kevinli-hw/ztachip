...
#endif
{23,0,  "DIV",        cConfig::eMuOpcodeDefAlu1,         cConfig::eMuOpcodeDefDataTypeFloat,true,    cConfig::eMuOpcodeDefDataTypeFloat,true,    cConfig::eMuOpcodeDefDataTypeFloat,true,       -1,0,0,-1}, //OPCODE_DIV
...
bool cConfig::IsMuCommutative(int opcode)
{
   ...
   case cConfig::OPCODE_DIV: return false;
